...
| `etcdOperator.image.tag`                          | etcd-operator container image tag                                    | `v0.9.2`                                       |
...
| `backupOperator.image.tag`                        | Operator container image tag                                         | `v0.9.2`                                       |
...
| `restoreOperator.image.tag`                       | Operator container image tag                                         | `v0.9.2`                                       |
...
| `etcdCluster.version`                             | etcd cluster version                                                 | `3.2.13`                                       |
| `etcdCluster.image.repository`                    | etcd container image                                                 | `quay.io/coreos/etcd-operator`                 |
| `etcdCluster.image.tag`                           | etcd container image tag                                             | `v3.2.13`                                      |
